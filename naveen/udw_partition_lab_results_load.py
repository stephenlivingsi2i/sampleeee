...
# export UDW_PARTITION_LAB_RESULTS_FILE_PATH="s3a://sureshn-sandbox-landing-bucket/udw/PARTITION_LAB_RESULTS.csv"
# export PARTITION_LAB_RESULTS_DELTA_TABLE_PATH="s3a://sureshn-sandbox-landing-bucket/delta-tables/udw/PARTITION_LAB_RESULTS"
...
def main():
    ...
    try:
        ...
        partition_lab_results_src_file_path = os.environ.get("UDW_partition_lab_results_FILE_PATH", "")
        ...
        partition_lab_results_df = src_df \
            .withColumn('clinical_result_type ', get_column(src_df,'ClinicalResultType'))\
            .withColumn('order_id ', get_column(src_df,'ORDER_ID', IntegerType()))\
            .withColumn('placer_entity_identifier ', get_column(src_df,'PLACER_ENTITY_IDENTIFIER'))\
            .withColumn('placer_namespace_id ', get_column(src_df,'PLACER_NAMESPACE_ID'))\
            .withColumn('transaction_date ', get_column(src_df,'TRANSACTION_DATE', DateType()))\
            .withColumn('order_status ', get_column(src_df,'ORDER_STATUS'))\
            .withColumn('order_control ', get_column(src_df,'ORDER_CONTROL'))\
            ...
            .withColumn('filler_entity_identifier ', get_column(src_df,'FILLER_ENTITY_IDENTIFIER'))\
            .withColumn('filler_namespace_id ', get_column(src_df,'FILLER_NAMESPACE_ID'))\
            .withColumn('accession_number ', get_column(src_df,'AccessionNumber'))\
            ...
            .withColumn('lab_test_type_code ', get_column(src_df,'LABTEST_TYPE_CODE'))\
            .withColumn('lab_test_type_other ', get_column(src_df,'LABTEST_TYPE_OTHER'))\
            .withColumn('lab_test_date ', get_column(src_df,'LABTEST_DATE', DateType()))\
            .withColumn('source_entry ', get_column(src_df,'SOURCE_ENTRY'))\
            .withColumn('specimen_received_date ', get_column(src_df,'SPECIMEN_RECEIVED_DATE', DateType()))\
            .withColumn('specimen_source_name_or_code ', get_column(src_df,'SPECIMEN_SOURCE_NAME_OR_CODE'))\
            ...
            .withColumn('observation_comment_source ', get_column(src_df,'OBSERVATION_COMMENT_SOURCE'))\
            .withColumn('observation_comment ', get_column(src_df,'OBSERVATION_COMMENT'))\
            .withColumn('lab_test_type_desc ', get_column(src_df,'LABTEST_TYPE_DESC'))\
            .withColumn('lab_test_coding_system_name ', get_column(src_df,'LABTEST_CODING_SYSTEM_NAME'))\
            .withColumn('specimen_action_code ', get_column(src_df,'SPECIMEN_ACTION_CODE'))\
            .withColumn('collected_by ', get_column(src_df,'COLLECTED_BY'))\
            .withColumn('test_status ', get_column(src_df,'TEST_STATUS'))\
            .withColumn('specimen_source_text ', get_column(src_df,'SPECIMEN_SOURCE_TEXT'))\
            ...
            .withColumn('obr_notes ', get_column(src_df,'OBR_NOTES'))\
            .withColumn('cpt_code ', get_column(src_df,'CPT_CODE'))\
            .withColumn('loinc_code ', get_column(src_df,'LOINC_CODE'))\
            .withColumn('lab_test_result_id ', get_column(src_df,'LABTEST_RESULT_ID', IntegerType()))\
            .withColumn('lab_test_code ', get_column(src_df,'LABTEST_CODE'))\
            .withColumn('lab_test_code_other ', get_column(src_df,'LABTEST_CODE_OTHER'))\
            .withColumn('lab_test_reason ', get_column(src_df,'LABTEST_REASON'))\
            .withColumn('lab_test_result_code ', get_column(src_df,'LABTEST_RESULT_CODE'))\
            .withColumn('units ', get_column(src_df,'UNITS'))\
            .withColumn('lab_test_result_date ', get_column(src_df,'LABTEST_RESULT_DATE', DateType()))\
            .withColumn('lab_test_reference_range ', get_column(src_df,'LABTEST_REFERENCE_RANGE'))\
            .withColumn('result_status ', get_column(src_df,'RESULT_STATUS'))\
            .withColumn('lab_test_result_desc ', get_column(src_df,'LABTEST_RESULT_DESC'))\
            .withColumn('abnormal_test_type ', get_column(src_df,'ABNORMAL_TEST_TYPE'))\
            .withColumn('lab_test_result_value ', get_column(src_df,'LABTEST_RESULT_VALUE'))\
            .withColumn('lab_test_notes ', get_column(src_df,'LABTEST_NOTES'))\
            ...
            .withColumn('lab_test_alternate_code ', get_column(src_df,'LABTEST_ALTERNATE_CODE'))\
            .withColumn('lab_test_alternate_coding_system_name ', get_column(src_df,'LABTEST_ALTERNATE_CODING_SYSTEM_NAME'))\
            .withColumn('lab_test_alternate_result_desc ', get_column(src_df,'LABTEST_ALTERNATE_RESULT_DESC'))\
            .withColumn('lab_company_id ', get_column(src_df,'LABCOMPANY_ID', IntegerType()))\
            .withColumn('lab_company_name ', get_column(src_df,'LAB_COMPANY_NAME'))\
            .withColumn('lab_test_result_coding_system_name ', get_column(src_df,'LABTEST_RESULT_CODING_SYSTEM_NAME'))\
