...
# export UDW_MEASURE_NDC_CODE_FILE_PATH="s3a://sureshn-sandbox-landing-bucket/udw/MEASURE_NDC_CODE.csv"
# export MEASURE_NDC_CODE_DELTA_TABLE_PATH="s3a://sureshn-sandbox-landing-bucket/delta-tables/udw/MEASURE_NDC_CODE"
...
def main():
    ...
    try:
        ...
        measure_ndc_code_src_file_path = os.environ.get("UDW_MEASURE_NDC_CODE_FILE", "")
        ...
        measure_ndc_code_df = src_df \
            ...
            .withColumn('dispense_use ', get_column(src_df,'Dispense_USE'))\
            .withColumn('ndc ', get_column(src_df,'NDC'))\
            .withColumn('rxn ', get_column(src_df,'rxn'))\
            .withColumn('code_desc ', get_column(src_df,'CODE_DESC'))\
            .withColumn('hie_source_code ', get_column(src_df,'HIE_SOURCE_CODE'))\
            .withColumn('supply ', get_column(src_df,'supply'))\
            .withColumn('quantity ', get_column(src_df,'Quantity'))\
