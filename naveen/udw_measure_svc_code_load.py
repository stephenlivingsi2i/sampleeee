...
# export UDW_MEASURE_SVC_CODE_FILE_PATH="s3a://sureshn-sandbox-landing-bucket/udw/MEASURE_SVC_CODE.csv"
# export MEASURE_SVC_CODE_DELTA_TABLE_PATH="s3a://sureshn-sandbox-landing-bucket/delta-tables/udw/MEASURE_SVC_CODE"
...
def main():
    ...
    try:
        ...
        measure_svc_code_src_file_path = os.environ.get("UDW_MEASURE_SVC_CODE_FILE_PATH", "")
        ...
        measure_svc_code_df = src_df \
            ...
            .withColumn('svc_code ', get_column(src_df,'SVCCODE'))\
            .withColumn('svc_descr ', get_column(src_df,'SVCDESCR'))\
            ...
            .withColumn('dob DATE', get_column(src_df,'DOB', DateType()))\
            .withColumn('claim_key ', get_column(src_df,'CLAIMKEY', IntegerType()))\
            .withColumn('bill_class_key ', get_column(src_df,'_billclasskey'))\
            .withColumn('modifier ', get_column(src_df,'Modifier'))\
            .withColumn('cpt_modifier ', get_column(src_df,'CPT_Modifier'))\
