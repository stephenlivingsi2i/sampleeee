...
os.environ['UDW_NGS_THERAPY_CLINICAL_TRIALS_PATH'] = 's3a://delta-lake-tables/udw/ngs_therapy_clinical_trials.csv'
os.environ['NGS_THERAPY_CLINICAL_TRIALS_DELTA_TABLE_PATH'] = 's3a://delta-lake-tables/delta-tables/udw/ngs_therapy_clinical_trials'
...
def main():
    ...
    try:
        ...
        ngs_therapy_clinical_trials_src_file_path = os.environ.get("UDW_NGS_THERAPY_CLINICAL_TRIALS_PATH", "")
        ...
        ngs_therapy_clinical_trials_df = src_df \
            ...
            .withColumn("therapy_details_therapy", get_column(src_df, "therapy_details_therapy", StringType())) \
            .withColumn("therapy_details_therapy_description", get_column(src_df, "therapy_details_therapy_description", StringType())) \
            .withColumn("indication_fda_approved", get_column(src_df, "indication_fda_approved", StringType())) \
            .withColumn("indication_nccn_recommended", get_column(src_df, "indication_nccn_recommended", StringType())) \
            .withColumn("indication_fda_uncertain_benefit", get_column(src_df, "indication_fda_uncertain_benefit", StringType())) \
            .withColumn("indication_nccn_uncertain_benefit", get_column(src_df, "indication_nccn_uncertain_benefit", StringType())) \
            .withColumn("indication_expanded_access", get_column(src_df, "indication_expanded_access", StringType())) \
            .withColumn("indication_benefit_statement", get_column(src_df, "indication_benefit_statement", StringType())) \
            .withColumn("indication_uncertain_benefit_statement", get_column(src_df, "indication_uncertain_benefit_statement", StringType())) \
            .withColumn("clinical_significance_amp_cap_asco_tier", get_column(src_df, "clinical_significance_amp_cap_asco_tier", StringType())) \
            .withColumn("clinical_significance_evidence", get_column(src_df, "clinical_significance_evidence", StringType())) \
            ...
            .withColumn("clinical_trials_phase", get_column(src_df, "clinical_trials_phase", StringType())) \
            .withColumn("clinical_trials_location", get_column(src_df, "clinical_trials_location", StringType())) \
            .withColumn("therapy_details_report_section", get_column(src_df, "therapy_details_report_section", StringType())) \
            .withColumn("marker_profiles_report_sections", get_column(src_df, "marker_profiles_report_sections", StringType())) \
            .withColumn("therapy_considerations_therapy", get_column(src_df, "therapy_considerations_therapy", StringType())) \
            .withColumn("therapy_considerations_indications", get_column(src_df, "therapy_considerations_indications", StringType())) \
            .withColumn("therapy_considerations_sources", get_column(src_df, "therapy_considerations_sources", StringType())) \
            .withColumn("therapy_considerations_other_tumor_type", get_column(src_df, "therapy_considerations_other_tumor_type", StringType())) \
            .withColumn("therapy_considerations_report_section", get_column(src_df, "therapy_considerations_report_section", StringType())) \
        ...
        spark.sql("""
            ...
            LOCATION 's3a://delta-lake-tables/delta-tables/udw/ngs_therapy_clinical_trials'
        """)
