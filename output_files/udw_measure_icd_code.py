...
os.environ['UDW_MEASURE_ICD_CODE_PATH'] = 's3a://delta-lake-tables/udw/measure_icd_code.csv'
os.environ['MEASURE_ICD_CODE_DELTA_TABLE_PATH'] = 's3a://delta-lake-tables/delta-tables/udw/measure_icd_code'
...
def main():
    ...
    try:
        ...
        measure_icd_code_src_file_path = os.environ.get("UDW_MEASURE_ICD_CODE_PATH", "")
        ...
        spark.sql("""
            ...
            LOCATION 's3a://delta-lake-tables/delta-tables/udw/measure_icd_code'
        """)
